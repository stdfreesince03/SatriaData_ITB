        ...
        <footer className="border-t border-gray-200 px-6 py-2 bg-white">
            <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-4 text-sm text-gray-600">
                ...
                <div className="flex flex-wrap gap-6">
                    <a href="#" className="hover:text-gray-900">Winata Tristan</a>
                    <a href="#" className="hover:text-gray-900">Francesco Michael Kusuma</a>
                    <a href="#" className="hover:text-gray-900">Maximilian Sulistiyo</a>
                </div>
